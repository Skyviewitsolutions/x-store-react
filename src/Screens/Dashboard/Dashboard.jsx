  ...
  return (
    <div className="col-sm-1 cardd">
      <div >
        ...
        <div className="Dash" style={{ background:props.bgColor,minHeight:"60px",justifyContent:"center", borderRadius:"5px",boxShadow:" rgba(0, 0, 0, 0.35) 0px 3px 8px",lineHeight:"60px;" ,paddingTop:"15px"}}>  {props.img}</div>
