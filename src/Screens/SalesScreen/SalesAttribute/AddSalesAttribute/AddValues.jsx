...
const AddValues = (props) => {
  ...
  const allValueUrl = endpoints.attribute.allAttributeValues;
  ...
  return (
    <div>
      ...
      <AttributeValues modalShow={modalShow} setModalShow={setModalShow} attributeDetails={attributeDetails} setAttributeDetails={setAttributeDetails} getAddLine={getAddLine}/>
      <ToastContainer />
    </div>
  );
};
