...
import Optional from '../../Quotations/AddQuotation/Optional';
import Other from '../../Quotations/AddQuotation/Other';

const AddSalesOrders = () => {
    const [events, setEvents] = useState("Products");
  return (
    <>
    <SalesNavbar showBelowMenu={true}  title="Sales Orders" showCanelBtn={true}/>
