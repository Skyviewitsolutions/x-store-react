...
const AddPurchaseAgreementTypes = () => {
    ...
    const addPurchaseagreementType = endpoints.purchaseAgreementtype.addAgreementtype;
    ...
    const save = () => {
        if(agreementType === ""){
           ...
           axios.post(addPurchaseagreementType , formData)
           .then((res) => {
            if(res.data.status === true){
                toast("Purchase Agreement Type added successfully",{type:"success"})
    ...
    const updateAgreementtypeurl = endpoints.purchaseAgreementtype.updateAgreementtype;
    ...
    useEffect(() => {
      ...
      const updateData = () => {
        if(agreementType === ""){
           ...
           formData.append("User_Authorization", getAuthtoken);
           formData.append("User_AuthKey", userAuth);
           axios.post(updateAgreementtypeurl , formData)
           .then((res) => {
            if(res.data.status === true){
                toast("Purchase Agreement Type updated successfully",{type:"success"})
            }else if(res.data.status === false){
                if(res.data.code === 3)
                {
                  toast("Session expired , Please re-login",{type:"warning"})
        ...
        <div className="AddPATContainer">
            <div className="addpatCon">
                    <div className="agrementType">
                        ...
                        <div className="atradio">
                            ...
                            <div className="asradio">
                                <input type="radio" name="only" onChange={(e) => setAgreementSelection("Select only one RFQ (exclusive)")} checked={agreementSelection === "Select only one RFQ (exclusive)" ? true :false}/>
                                <span>Select only one RFQ (exclusive)</span>
                            </div>
                            <div className="asradio">
                                <input type="radio" name='only' onChange={(e) => setAgreementSelection("Select multiple RFQ") } checked={agreementSelection === "Select multiple RFQ" ? true : false}/>
                    ...
                    <div className="dataradio">
                            ...
                            <div className="radio">
                            <div className="asradio">
                                <input type="radio" name="lines" onChange={(e) => setDataforQuotation("Use lines of agreement")} checked={dataforquotation === "Use lines of agreement"?true:false}/>
                                <span>Use lines of agreement</span>
                            </div>
                            <div className="asradio">
                                <input type="radio" name='lines' onChange={(e) => setDataforQuotation("Do not create RfQ lines automatically")}  checked={dataforquotation === "Do not create RfQ lines automatically" ? true : false}/>
                    ...
                    <div className="dataradio">
                            ...
                            <div className="radio">
                            <div className="asradio">
                                <input type="radio" name="quanties"  onChange={(e) => setQuantites("Use quantities of agreement")} checked={quantites === "Use quantities of agreement" ? true : false}/>
                                <span>Use quantities of agreement</span>
                            </div>
                            <div className="asradio">
                                <input type="radio" name='quanties' onChange={(e) => setQuantites("Set quantities manually")} checked={quantites === "Set quantities manually" ? true : false}/>
