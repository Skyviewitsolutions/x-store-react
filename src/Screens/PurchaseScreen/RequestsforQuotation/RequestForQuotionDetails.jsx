...
const userAuth = localStorage.getItem("userAuth");
  ...
  const getSingleData = () => {
    ...
    axios.post(singlerfqUrl,formData)
    .then((res) => {
  ...
  return (
    <div>
      ...
      <PurchaseHeader  isEdit={isEdit} setIsEdit={setIsEdit} Print={Print}/>
         <div className="addRequestQuoPContainers">
        ...
        <div className="Warehouse">
          {events === "Products" && <RFQProduct  singleProduct={singleProduct} setSingleProduct={setSingleProduct}/>}
          {events === "Other Information" && <RFQOtherInfo  singleRFQ={singleRFQ} />}
        </div>
     {showInvoice === true &&  <div ref={componentRef}>
