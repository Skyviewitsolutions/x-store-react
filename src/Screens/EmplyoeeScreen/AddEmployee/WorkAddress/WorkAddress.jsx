...
const WorkAddress = () => {
    ...
    const getWorkAddress = () => {
        ...
        axios.post(getWorkAddrUrl ,formData)
        .then((res) => {
            if(res.data.status === true){
                setAllWorkAddress(res.data.data)
...
const deleteItem = (data) => {
    const formData = new FormData();
        ...
        formData.append("User_Authorization", getAuthtoken);
        formData.append("User_AuthKey", userAuth);
        axios.post(deleteWorkAddress,formData)
        .then((res) => {
            if(res.data.status === true)
            {
                getWorkAddress();
  ...
  return (
    <div>
        <EmployeeNavbar showBelowMenu={true} title="Work Address" handleCreatePage={handleCreatePage}/>
