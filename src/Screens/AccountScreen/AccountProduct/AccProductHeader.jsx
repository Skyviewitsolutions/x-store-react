...
import PrintProductBarcode from '../../InventoryScreen/AddAccount/PrintProductBarcode/PrintProductBarcode';

const AccProductHeader = (props) => {
...
export default AccProductHeader