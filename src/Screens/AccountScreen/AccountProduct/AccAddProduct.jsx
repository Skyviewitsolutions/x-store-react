...
import AccProductHeader from './AccProductHeader';
...
const AccAddProduct = () => {
  ...
  return (
    <div>
        <AccountNavbar  showBelowMenu={false} />
        <AccProductHeader isEdit={isEdit} setIsEdit={setIsEdit} save={save} />
