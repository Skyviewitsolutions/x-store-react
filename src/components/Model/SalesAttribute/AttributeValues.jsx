...
const AttributeValues = (props) => {
    ...
    const {modalShow , setModalShow,attributeDetails,setAttributeDetails} = props;
  ...
  return (
        <Modal show={modalShow} size='lg'>
           <div className="attribute_valuesmain">
            <div className="att_value_con">
                   <div className="att_contents">
                    <p>Attribute Value</p>
                    <input type="text" value={attributeValue} onChange={(e) => setAttributeValue(e.target.value)}/>
                   </div>
           ...
           <button className='pur_btn' onClick={() => addValue()}>Save</button>
            </div>
